        ...
        <>
            <div className="flex flex-col gap-5 p-4 md:p-8">
                <div className="flex flex-col md:flex-row justify-between gap-4">
                    ...
                    <input onInput={(event) => searchUser(event)} className="border-2 text-lg border-purple-500 w-full md:w-96 px-2 py-1 text-center rounded-md" type="text" placeholder="search..." />
                </div>
                <div className="relative overflow-x-auto sm:rounded-lg shadow-xl">
                    <table className="min-w-full text-sm text-left rtl:text-right text-black dark:text-black font-bold">
                        ...
                        <tbody>
                            {Array.isArray(users) && users.map((item) => (
                                <tr key={item.id} className="bg-white border-b-2 border-purple-300 dark:bg-white hover:bg-grey-200 dark:hover:bg-grey-300">
                                    ...
                                    <td scope="col" className="px-6 py-3 cursor-pointer">
                                        <svg onClick={() => navigate('/view', { state: item })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:animate-ping">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" />
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                                        </svg>
                                    </td>
                                    <td scope="col" className="px-6 py-3">
                                        <svg onClick={() => navigate('/edit', { state: item })} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:animate-ping cursor-pointer">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                                        </svg>
                                    </td>
                                    <td scope="col" className="px-6 py-3">
                                        <svg onClick={() => deleteUser(item._id)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 hover:animate-ping cursor-pointer">
